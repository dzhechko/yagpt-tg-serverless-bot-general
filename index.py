...
Я бот-помощник, который построен на базе YandexGPT.
...
Ты можешь выбрать модель YaGPT, которую хочешь использовать (https://cloud.yandex.ru/ru/docs/yandexgpt/concepts/models).
...
async def show_chat_modes_handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    /model = lite     для YandexGPT lite
    /model = pro      для YandexGPT
    """
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    (но не забудь выставить нужную степень моей креативности!)
    🤖\n
    """
...
async def process_text_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if  message_text == "/start":
        ...
        yagpt_prompt = """
        Отвечай на вопросы коротко и точно. Следуй пожеланиям пользователя, до тех пор пока они не выходят за рамки этики. Если не знаешь ответ, вежливо напиши об этом.
        """
